import { loadAuthData, isAuthDataValid, clearAuthData, getAuthStatus } from '../linkedin/session/credential-store.js';
import { performAuthentication } from '../linkedin/session/browser-login.js';
 ...
 */
export const handleSession = async (params: AuthParams) => {
